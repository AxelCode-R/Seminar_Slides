...
\end{aligned}
$$
Theorem 1: Gegeben $w$, $c_p$, $c_g \geq 0$ und es gilt $0 \leq w <1$ und $0 < c_p + c_g < 4\cdot(1+w)$ dann konvergiert der iterative Prozess $E(x^i)_{i \in \mathbb{N}}$ garantiert gegen
$$
...
$$
dann konvergiert der iterative Prozess $Var(x^i)_{i \in \mathbb{N}}$ garantiert gegen
$$
